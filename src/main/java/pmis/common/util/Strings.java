...
public class Strings {
	...
	private static RuntimeException error ( String message ) {
		return new RuntimeException( "Strings: " + message );
	}
	...
	public static String replaceString ( String origin, String pattern, String substPattern ) {
		...
		StringBuilder iniziale = new StringBuilder( origin );
		do {
	...
	public static String defaultValue( Object string, String defaultValue ) {
		return defaultValue( (String)string, defaultValue );
	}
	...
	public static String parse( String string ) {
		if ( hasText(string) ) {
			return trimOrNull( string.replaceAll("[\n\r]", " " ) );
		}
		return string;
	}
	
	public static int parseInt(String str) {
		return Integer.parseInt(Strings.defaultValue(str,"0"));
	}
}